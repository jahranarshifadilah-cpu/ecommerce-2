    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-md-5">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Bergabunglah dengan komunitas belanja kami hari ini.</p>
            </div>
                ...
                <div class="card-body p-4 p-lg-5">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="name" type="text" 
                                ...
                                placeholder="Masukkan nama lengkap Anda" style="font-size: 1rem; border-radius: 12px;">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password" type="password" 
                                ...
                                placeholder="Minimal 8 karakter" style="font-size: 1rem; border-radius: 12px;">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        {{-- Confirm Password --}}
                        <div class="mb-4">
                            <label for="password-confirm" class="form-label fw-semibold text-slate-700 small">KONFIRMASI PASSWORD</label>
                            <input id="password-confirm" type="password" 
                                class="form-control form-control-lg bg-light border-0" 
                                name="password_confirmation" required autocomplete="new-password"
                                placeholder="Ulangi password" style="font-size: 1rem; border-radius: 12px;">
                        </div>
                    ...
                    <div class="text-center">
                        <p class="mb-0 text-muted small">
                            Sudah memiliki akun? <a href="{{ route('login') }}" class="text-navy fw-bold text-decoration-none">Masuk di sini</a>
                        </p>
                    </div>
                </div>
            </div>
